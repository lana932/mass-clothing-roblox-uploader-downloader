try:
    ...
    print("Run Requirements.bat and setup.exe to run the program.")
    input()
...
# If failed, it means the cookie is invalid, so the user will be told that
    ...
    print(f"Your cookie is invalid dont forget to run setup.exe")
    input()

print("Choose what type of clothing you would like to download\nRemember to run setup.exe before downloading!")
print("Clothing\n- Shirts (s)\n- Pants (p)")
